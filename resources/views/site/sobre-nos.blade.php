@extends('site.layouts.basico') {{-- extende o template criado --}}

@section('titulo', 'Sobre Nós')

@section('conteudo') {{-- indica o nome e o conteúdo da seção que vai ser renderizada dentro do 'yield' do template --}}
