...
<form action="{{ route('site.contato') }}" method="post">
    ...
    <input name="nome" value="{{ old('nome') }}" type="text" placeholder="Nome" class="{{ $classe }}"> {{-- usamos a variável passada no array associativo do @component --}}
    {{ $errors->has('nome') ? $errors->first('nome') : '' }} {{-- mostra a mensagem de erro de validação relacionada ao campo --}}
    <br>
